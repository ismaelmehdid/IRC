...
Server::Server() : _socket(), _clients(), _channels(), _nbr_clients(0), _password() {}

Server::Server(const std::string &password) : _socket(), _clients(), _channels(), _nbr_clients(0), _password(password) {}
